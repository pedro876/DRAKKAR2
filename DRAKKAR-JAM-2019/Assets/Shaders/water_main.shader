    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_4118 = (length(node_9712)+(-0.9));
                float node_9080 = 2.0;
                float node_7645 = (1.0 - saturate(floor(node_4118 * node_9080) / (node_9080 - 1)));
