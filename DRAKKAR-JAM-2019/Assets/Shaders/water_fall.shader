...
////// Emissive:
                ...
                float3 node_3875 = (_Texture_var.rgb+smoothstep( clamp(node_3867,0,0.5), (0.75+(node_8602*node_1731)), clamp(node_5762,0,1) ));
